...
public class BG_B : IDisposable {
  ...
  public BG_B(SignalProcessingDataStore.SignalProcessingDataStore datastoreSignalProcessing) {
  ...
  void CreateObjects() {
    ...
    _objSignalProcessingSignalOscillator0.SetFrequency(200f);
    ...
    _objSignalProcessingSignalMathOp1.SetOperandB(0.09f);
    ...
    _objSignalProcessingSignalOscillator2.SetFrequency(7f);
