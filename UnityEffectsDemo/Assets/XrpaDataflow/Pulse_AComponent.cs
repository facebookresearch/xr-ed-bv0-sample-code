...
public class Pulse_AComponent : MonoBehaviour {
  ...
  private XrpaDataflow.Pulse_A _currentObj;
  ...
  public void Run() {
    Stop();
    _currentObj = new XrpaDataflow.Pulse_A(SignalProcessingDataStoreSubsystem.Instance.DataStore);
  ...
  public XrpaDataflow.Pulse_A Spawn() {
    var ret = new XrpaDataflow.Pulse_A(SignalProcessingDataStoreSubsystem.Instance.DataStore);
