...
public class BasicWave : IDisposable {
  ...
  public BasicWave(SignalProcessingDataStore.SignalProcessingDataStore datastoreSignalProcessing) {
  ...
  void CreateObjects() {
    ...
    _objSignalProcessingSignalOutputDevice2 = _datastoreSignalProcessing.SignalOutputDevice.CreateObject();
    ...
    _objSignalProcessingSignalOutputDevice2.SetSrcNode(_objSignalProcessingSignalMathOp1.GetXrpaId());
    _objSignalProcessingSignalOutputDevice2.SetOutputToSystemAudio(true);
    _objSignalProcessingSignalOutputDevice2.SetChannelOffset(0);
  }

  void DestroyObjects() {
    if (_objSignalProcessingSignalOutputDevice2 != null) {
      _datastoreSignalProcessing.SignalOutputDevice.RemoveObject(_objSignalProcessingSignalOutputDevice2.GetXrpaId());
