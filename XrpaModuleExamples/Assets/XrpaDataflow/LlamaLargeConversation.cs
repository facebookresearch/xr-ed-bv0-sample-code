...
public class LlamaLargeConversation : IDisposable {
  ...
  public LlamaLargeConversation(LlmHubDataStore.LlmHubDataStore datastoreLlmHub) {
  ...
  public void SetTemperature(float Temperature) {
    ...
    if (_objLlmHubLlmConversation0 != null) {
      _objLlmHubLlmConversation0.SetTemperature(Temperature);
    }
  }
  ...
  void CreateObjects() {
    ...
    _objLlmHubLlmConversation0.SetTemperature(_paramTemperature);
