...
public class GainWaveComponent : MonoBehaviour {
  [SerializeField]
  ...
  private XrpaDataflow.GainWave _currentObj;
  ...
  public void Run() {
    Stop();
    _currentObj = new XrpaDataflow.GainWave(SignalProcessingDataStoreSubsystem.Instance.DataStore);
  ...
  public XrpaDataflow.GainWave Spawn() {
    var ret = new XrpaDataflow.GainWave(SignalProcessingDataStoreSubsystem.Instance.DataStore);
    ret.SetAmp(Amp);
    ret.SetFq(Fq);
    ret.SetGain0(Gain0);
    ret.SetGain1(Gain1);
