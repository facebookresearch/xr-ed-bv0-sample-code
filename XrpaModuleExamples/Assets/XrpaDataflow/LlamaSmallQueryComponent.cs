...
public class LlamaSmallQueryComponent : MonoBehaviour {
  [SerializeField]
  ...
  private XrpaDataflow.LlamaSmallQuery _currentObj;
  ...
  public void Run() {
    Stop();
    _currentObj = new XrpaDataflow.LlamaSmallQuery(LlmHubDataStoreSubsystem.Instance.DataStore);
  ...
  public XrpaDataflow.LlamaSmallQuery Spawn() {
    var ret = new XrpaDataflow.LlamaSmallQuery(LlmHubDataStoreSubsystem.Instance.DataStore);
