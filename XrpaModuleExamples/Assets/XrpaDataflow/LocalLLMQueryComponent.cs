...
public class LocalLLMQueryComponent : MonoBehaviour {
  [SerializeField]
  ...
  private XrpaDataflow.LocalLLMQuery _currentObj;
  ...
  public void Run() {
    Stop();
    _currentObj = new XrpaDataflow.LocalLLMQuery(LlmHubDataStoreSubsystem.Instance.DataStore);
  ...
  public XrpaDataflow.LocalLLMQuery Spawn() {
    var ret = new XrpaDataflow.LocalLLMQuery(LlmHubDataStoreSubsystem.Instance.DataStore);
