...
public class LocalLLMQuery : IDisposable {
  ...
  public LocalLLMQuery(LlmHubDataStore.LlmHubDataStore datastoreLlmHub) {
  ...
  void CreateObjects() {
    ...
    _objLlmHubLlmQuery0.SetApiProvider((LlmHubDataStore.ApiProvider)(uint)(2));
