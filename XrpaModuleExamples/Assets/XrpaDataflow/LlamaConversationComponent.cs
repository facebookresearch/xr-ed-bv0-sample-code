...
public class LlamaConversationComponent : MonoBehaviour {
  [SerializeField]
  ...
  private XrpaDataflow.LlamaConversation _currentObj;
  ...
  public void Run() {
    Stop();
    _currentObj = new XrpaDataflow.LlamaConversation(LlmHubDataStoreSubsystem.Instance.DataStore);
  ...
  public XrpaDataflow.LlamaConversation Spawn() {
    var ret = new XrpaDataflow.LlamaConversation(LlmHubDataStoreSubsystem.Instance.DataStore);
