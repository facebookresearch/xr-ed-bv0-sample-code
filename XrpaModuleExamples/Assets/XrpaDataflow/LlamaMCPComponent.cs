...
public class LlamaMCPComponent : MonoBehaviour {
  [SerializeField]
  ...
  private XrpaDataflow.LlamaMCP _currentObj;
  ...
  public void Run() {
    Stop();
    _currentObj = new XrpaDataflow.LlamaMCP(LlmHubDataStoreSubsystem.Instance.DataStore);
  ...
  public XrpaDataflow.LlamaMCP Spawn() {
    var ret = new XrpaDataflow.LlamaMCP(LlmHubDataStoreSubsystem.Instance.DataStore);
