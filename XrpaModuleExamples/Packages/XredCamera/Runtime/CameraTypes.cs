...
public class CameraDataStoreConfig {
  public static Xrpa.TransportConfig GenTransportConfig() {
    Xrpa.TransportConfig config = new();
    config.SchemaHash = new Xrpa.HashValue(0x741a333e056b3725, 0xe5228508c55848a9, 0xb4135ad103636a95, 0x635e1ae3d8c0e867);
    config.ChangelogByteCount = 11899792;
    return config;
  }
}
