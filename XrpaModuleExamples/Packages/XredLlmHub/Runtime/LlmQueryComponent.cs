...
public class LlmQueryComponent : MonoBehaviour {
  [SerializeField]
  ...
  public byte[] JpegImageData {
    ...
    set {
      ...
      if (_xrpaObject != null) { _xrpaObject.SetJpegImageData(value); }
    }
  }

  protected Xrpa.ObjectUuid _id = new Xrpa.ObjectUuid{ID0 = 0UL, ID1 = 0UL};
  protected LlmHubDataStore.OutboundLlmQuery _xrpaObject;
  ...
  void OnValidate() {
    ...
    if (_xrpaObject != null) { _xrpaObject.SetJpegImageData(_JpegImageData); }
  }
  ...
  public void SendQuery(string data, byte[] jpegImageData, int id) {
    _xrpaObject?.SendQuery(data, jpegImageData, id);
  }
  ...
  public void InitializeDS() {
    ...
    _xrpaObject = new LlmHubDataStore.OutboundLlmQuery(_id);
    _xrpaObject.SetXrpaOwner(this);
    LlmHubDataStoreSubsystem.Instance.DataStore.LlmQuery.AddObject(_xrpaObject);
    ...
    _xrpaObject.SetJpegImageData(_JpegImageData);
  ...
  void DeinitializeDS() {
    ...
    LlmHubDataStoreSubsystem.MaybeInstance?.DataStore.LlmQuery.RemoveObject(_id);
    _xrpaObject = null;
