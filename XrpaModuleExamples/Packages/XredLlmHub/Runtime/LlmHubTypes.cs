...
public class LlmHubDataStoreConfig {
  public static Xrpa.TransportConfig GenTransportConfig() {
    Xrpa.TransportConfig config = new();
    config.SchemaHash = new Xrpa.HashValue(0x60a69d994c0387a0, 0x370d54e425475aae, 0xee71a9202fbcf39f, 0x9ba8e9fdf265078c);
    config.ChangelogByteCount = 470080000;
    return config;
  }
}

public enum ApiProvider : uint {
  MetaGenProxy = 0,
  LlamaAPI = 1,
  LocalLLM = 2,
}

public enum ModelSizeHint : uint {
  Small = 0,
  Large = 1,
}
