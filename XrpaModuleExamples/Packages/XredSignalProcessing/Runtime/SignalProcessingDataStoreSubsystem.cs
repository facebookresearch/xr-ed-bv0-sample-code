...
public class SignalProcessingDataStoreSubsystem : MonoBehaviour {
  ...
  public static SignalProcessingDataStoreSubsystem Instance {
    get {
      if (_Instance == null) {
        _Instance = FindAnyObjectByType<SignalProcessingDataStoreSubsystem>();
      }
      if (_Instance == null) {
  ...
  void Awake() {
    if (_Instance == null) {
      ...
      var transportSubsystem = SignalProcessingTransportSubsystem.Instance;
      DataStore = new SignalProcessingDataStore.SignalProcessingDataStore(transportSubsystem.SignalProcessingInboundTransport, transportSubsystem.SignalProcessingOutboundTransport);
