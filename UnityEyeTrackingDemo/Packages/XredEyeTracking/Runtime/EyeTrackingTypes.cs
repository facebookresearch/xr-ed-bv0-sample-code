...
public class EyeTrackingDataStoreConfig {
  public static Xrpa.TransportConfig GenTransportConfig() {
    Xrpa.TransportConfig config = new();
    config.SchemaHash = new Xrpa.HashValue(0x2c6f556bae2a2d8f, 0x97550f7bc9cc0736, 0x7ec8ce9c8fb2e0a7, 0xf7fa50df2f8c2c47);
...
public class DSScale2 {
  public static UnityEngine.Vector2 ReadValue(Xrpa.MemoryAccessor memAccessor, Xrpa.MemoryOffset offset) {
    float x = memAccessor.ReadFloat(offset);
    float y = memAccessor.ReadFloat(offset);
    return new UnityEngine.Vector2{x = x, y = y};
  }

  public static void WriteValue(UnityEngine.Vector2 val, Xrpa.MemoryAccessor memAccessor, Xrpa.MemoryOffset offset) {
